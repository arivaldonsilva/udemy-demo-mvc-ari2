...
public class CargoController {
	...
	@PostMapping("/salvar")
	public String salvar(@Valid Cargo cargo, BindingResult results, RedirectAttributes attr ) {
	...
	@PostMapping("/editar")
	public String editar(@Valid Cargo cargo, BindingResult results, RedirectAttributes attr ) {
		if(results.hasErrors()) {
			return "cargo/cadastro";
		}
	...
	public String excluir(@PathVariable("id") Long id, ModelMap model) {
		if(cargoService.cargoTemFuncionarios(id)) {
			model.addAttribute("fail", "Cargo nao pode ser excluído, pois possui funcionários vinculados!");
		}
		else{
